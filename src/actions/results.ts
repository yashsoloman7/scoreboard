    ...
    entries: (insertedEntries || []).map((e: any) => ({
      ...
      performance: e.performance ? {
        ...
        participant: e.performance.participant ? {
          ...
          createdAt: e.performance.participant.created_at,
          updatedAt: e.performance.participant.updated_at,
        } : null,
        team: e.performance.team ? {
          ...
          createdAt: e.performance.team.created_at,
        } : null,
        createdAt: e.performance.created_at,
        updatedAt: e.performance.updated_at,
      } : null,
      createdAt: e.created_at,
    })) as ResultEntry[],
  };
